...
@Component({
    ...
    template: `
            <div>
              ...
              <hr/>
              <!--<event-detail #ddtail [event1]="event1"></event-detail>-->
              <div *ngFor="let eventx of eventevent" class="col-md-5">
                <event-detail  (click)="handleNailClick(eventx.name)"   [eventx]="eventx"></event-detail>
              </div>
              <!--<h3>{{ddtail.someproperty}}</h3>-->
              <button class="btn btn-primary" (click)="ddtail.logfoo()">Log foo</button>
            </div>`
})
...
export class EventListComponent {
  ...
  handleNailClick(evnetname){
    toastr.success(evnetname);
  }
}